...
path_raw_data = Path("input/2024/2024-02")  # raw attendance data
month = 2  # specify to obtain current month data only
df_trainer_sheet_name = "2024-02"  # sheet name in trainer data
